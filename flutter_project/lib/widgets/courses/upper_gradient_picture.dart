    ...
    return Stack(
      children: <Widget>[
        Container(
          height: height * 0.3,
          width: width,
          decoration: width < limitWidth
              ? BoxDecoration(image: DecorationImage(image: AssetImage("assets/courses.png"), fit: BoxFit.cover))
              : BoxDecoration(image: DecorationImage(image: AssetImage("assets/coursesTablet.png"), fit: BoxFit.cover)),
          child: Container(
