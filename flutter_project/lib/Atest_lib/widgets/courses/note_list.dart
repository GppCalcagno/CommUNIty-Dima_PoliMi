      ...
      itemBuilder: (context, index) {
        return Dismissible(
          ...
          child: Padding(
            ...
            child: Card(
              color: notes[index].author.uid == userID ? Color.fromARGB(255, 134, 97, 236).withOpacity(0.45) : null,
              child: ListTile(
                  ...
                  onTap: () {
                    if (notifyPick != null) {
                      ...
                      Navigator.pushNamed(context, "/courses/reviews/showNote");
                  ...
                  subtitle: Column(
                    ...
                    children: [
                      ...
                      Text("Character in The Descrption: ${notes[index].description?.length.toString() ?? "0"}"),
