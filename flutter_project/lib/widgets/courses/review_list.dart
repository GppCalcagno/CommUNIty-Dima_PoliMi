      ...
      itemBuilder: (context, index) {
        return Dismissible(
          ...
          child: Padding(
            ...
            child: Card(
              color: reviews[index].author.uid == userID ? Color.fromARGB(255, 134, 97, 236).withOpacity(0.5) : null,
              child: ListTile(
                key: Key(reviews[index].name),
                minLeadingWidth: 15,
                ...
                onTap: () {
                  if (notifyPick != null) {
                    ...
                    debugPrint("Tap on Review ${reviews[index].name}");
                    context.push('/courses/reviews/showReview', extra: reviews[index]);
                  }
                },
              ),
            ),
