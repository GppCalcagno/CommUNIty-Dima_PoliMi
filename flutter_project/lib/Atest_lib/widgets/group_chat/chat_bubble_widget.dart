                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            title: Text(key: Key('profileInfo'), 'Profile Info', textAlign: TextAlign.center, style: TextStyle(fontSize: !isTablet ? 20 : 24)),
                            content: Column(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                Row(
                                  children: [
                                    Text(key: Key('username'), 'Username: ', style: TextStyle(fontWeight: FontWeight.bold, fontSize: !isTablet ? 16 : 20)),
                                    Flexible(child: Text(sender.username, style: TextStyle(fontSize: !isTablet ? 16 : 20))),
                                  ]
                                ),
                                Row(
                                  children: [
                                    Text(key: Key('email'),'Email: ', style: TextStyle(fontWeight: FontWeight.bold, fontSize: !isTablet ? 16 : 20)),
                                    Flexible(child: Text(sender.email, style: TextStyle(fontSize: !isTablet ? 16 : 20))),
                                  ],
                                ),
                                Row(
                                  children: [
                                    Text(key: Key('firstName'), 'First name: ', style: TextStyle(fontWeight: FontWeight.bold, fontSize: !isTablet ? 16 : 20)),
                                    Flexible(child: Text(sender.firstName ?? '', style: TextStyle(fontSize: !isTablet ? 16 : 20))),
                                  ],
                                ),
                                Row(
                                  children: [
                                    Text(key: Key('lastName'), 'Last name: ', style: TextStyle(fontWeight: FontWeight.bold, fontSize: !isTablet ? 16 : 20)),
