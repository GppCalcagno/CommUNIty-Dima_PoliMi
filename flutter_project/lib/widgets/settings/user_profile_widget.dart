...
import 'package:dima_project/widgets/settings/edit_field_widget.dart';
import 'package:dima_project/widgets/settings/profile_image_widget.dart';
import 'package:dima_project/widgets/settings/upper_gradient_picture.dart';
import 'package:flutter/material.dart';
import 'package:image_picker/image_picker.dart';

class UserProfileWidget extends StatefulWidget {
  final UserModel currentUser;
  const UserProfileWidget({super.key, required this.currentUser});
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          Transform.translate(
            offset: Offset(0.0, -(height * 0.015)),  
            child: Container(
              height: 20,
              width: width,
          ...
          SizedBox(
            ...
            child: Row(
              ...
              children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: buildName(username, widget.currentUser.email)
                      ),
                            ...
                            Row(
                              ...
                              children: [
                                Switch(
                                    ...
                                    activeColor: Theme.of(context).brightness == Brightness.light ? Colors.deepPurple[400]: Colors.deepPurple[50],
                ...
                if (width > limitWidth) const SizedBox(width: 50),
                if (width > limitWidth)
                  const SizedBox(
                    width: 300,
                    child: Image(
            ...
            children: [
              ListView(
                ...
                children: [
                  ...
                  ListTile(leading: const Icon(Icons.person), title: const Text('Choose an avatar'), onTap: () => _onTapShowDialog(context)),
                  ListTile(
