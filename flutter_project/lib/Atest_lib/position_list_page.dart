...
import 'package:dima_project/Atest_lib/widgets/network/upper_gradient_picture_position.dart';
  ...
  _openShareDialog() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text("Share your position", textAlign: TextAlign.center, style: TextStyle(fontSize: 20, color: Colors.deepPurple[400])),
