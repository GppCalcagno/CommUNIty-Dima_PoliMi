...
import 'package:dima_project/widgets/courses/courses_lists.dart';
import 'package:dima_project/widgets/courses/upper_gradient_picture.dart';
                  ...
                  Row(
                    ...
                    children: [
                      Text(isShortList ? "Compact List" : "Extended List",
                          style: TextStyle(color: isShortList ? Colors.deepPurple[400] : Colors.blue[400], fontSize: 19)),
                      SizedBox(width: 10),
                      Switch(
                        key: Key("switch"),
                ...
                if (!snapshot.hasData || snapshot.connectionState != ConnectionState.done) {
                  ...
                  return Expanded(
                    child: Row(
                      ...
                      children: [
                        Container(
                          width: width > limitWidth ? 650 : MediaQuery.of(context).size.width-20,
                          child: isShortList
          ...
          return AlertDialog(
            ...
            content: FutureBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
                if (snapshot.hasData) {
                  return SizedBox(
                    height: MediaQuery.of(context).size.width < limitWidth ? 300 : 550, // Chan,ge as per your requirement
                    width: MediaQuery.of(context).size.width < limitWidth ? 300 : 500, // Change as per your requirement
                    child: ListView.builder(
                      shrinkWrap: true,
                      itemCount: snapshot.data.length,
                      itemBuilder: (BuildContext context, int index) {
                        return ListTile(
                          dense: MediaQuery.of(context).size.width < limitWidth,
                          ...
                          onTap: () => {
                            ...
                            setState(() {
                              userCourses = dbService.getUserCourses();
                              userCourses = Future.delayed(const Duration(milliseconds: 500), () => dbService.getUserCourses());
                            }),
                          },
                        );
                      },
