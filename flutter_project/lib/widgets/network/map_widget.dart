...
class MapState extends State<MapWidget> {
  ...
  void initState() {
    ...
    //userPoint = LatLng(45.4603865, 9.2045874); //TEST
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  IconButton(
                    icon: currentPosition != null ? Icon(Icons.directions_car_rounded, color: Colors.amber) : Icon(Icons.directions_car_rounded),
                    onPressed: () async {
                      currentPosition != null ? await _getRoute(myPoint!, userPoint, 'car') : null;
                    },
                  ),
                  IconButton(
                    icon: currentPosition != null ? Icon(Icons.directions_walk_rounded, color: Colors.amber) : Icon(Icons.directions_walk_rounded),
                    onPressed: () async {
                      currentPosition != null ? await _getRoute(myPoint!, userPoint, 'foot') : null;
                    },
                  ),
                  IconButton(
                    icon: currentPosition != null ? Icon(Icons.my_location_rounded, color: Colors.amber) : Icon(Icons.my_location_rounded),
                    onPressed: () async {
                      if (currentPosition != null) {
                        setState(() {
  ...
  _getUserAddress() async {
    List<Placemark> placemarks =
        await placemarkFromCoordinates(double.parse(widget.userPosition.latitude), double.parse(widget.userPosition.longitude));
    setState(() {
