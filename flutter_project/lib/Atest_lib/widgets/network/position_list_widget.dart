...
import 'package:dima_project/Atest_lib/widgets/network/position_el_inlist_widget.dart';
        ...
        children: [
          ...
          Expanded(
            child: RefreshIndicator(
              ...
              child: positionList.isNotEmpty ? ListView.builder(
                shrinkWrap: true,
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Text('  YOUR SHARED POSITION', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 14, color: Colors.deepPurple[400])),
                              ],
                            ),
                            PositionListElementWidget(user: user, color: Colors.deepPurple[300]),
                    ...
                    return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            InkWell(
                              onTap: () {
                                PositionModel pos = PositionModel(latitude: user.position!.latitude, longitude: user.position!.longitude, 
                                timestamp: user.position!.timestamp, description: user.position!.description ?? "", courseName: user.position!.courseName ?? "");
              ...
              : Center(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Image.asset('assets/noPositionFound.png', width: 200, height: 200, ),
